...
module assembly() {
	...
	translate([-65.9,-69,-60]) rotate([0,-90,0]) {
		extruderAssembly();
	}
...
//	translate([0,0,-50]) limits(200,200);
...
module wood3mm() {
	...
	translate([200, 200]) caseSideRight();
	translate([200, 200]) extruderClampPlate();
